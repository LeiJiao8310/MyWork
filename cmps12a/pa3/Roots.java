/**
 * Program 4 (Pair programming)
 * Name1: LEi JIAO         CruzID: 1513749
 * Name2: Chin-shu Shao
 * This program calculates the roots of a polynomial function after user enters
 * the degree and coefficients and two end points of the function.
 * The PAIR file will be submitted by Chin-shu Shao.
 **/
import java.util.*;
public class Roots {
    ...
    public static void main(String[] args){
        ...
        int i,dgr,m;
        double tolerance = 0.0000001,threshold=0.001,resolution = 0.01,Lft=0.0 ,Rht=0.0;
        double[] C;
